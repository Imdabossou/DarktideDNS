...
Looking into Console Logs I found endless spam of:
...
14:55:00.986 warning: [PingSystem] Failed to resolve ping DNS hostname: echo-prod-ga-aws-eu-west-1.atoma.cloud
 ...
 Simply run this .SH file as root, and it will fill the hosts file at /etc/hosts with all Darktide servers like this:
